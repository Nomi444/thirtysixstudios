  ...
  return (
    <>
      ...
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']">
       ...
       { showCanvas && data[0].map((canvadets, index) => (
         <Canvas details={canvadets}/>
        ))}
        <div className="w-full relative z-[1] h-screen ">
          ...
          <div className="text w-[40%]">
            ...
            <p className="text-lg w-[80%] mt-10 font-normal">We’re a boutique production studio focused on design, motion, and creative technology, constantly reimagining what digital craft can do for present-time ads and campaigns.
           </p>
          ...
          <div className="w-full absolute bottom-0 left-0">
            <h1 ref={headingref} className="text-[17rem] font-normal tracking-tight leading-none pl-5">Thirtysixstudios</h1>
          </div>
          </div>
        </div>
     </div>
     ...
     {data[1].map((canvadets, index) => (
         <Canvas details={canvadets}/>
        ))}

        <div className="relative z-[1]">
        <h1 className="text-8xl tracking-tighter">about the brand</h1>
        <p className="text-4xl leading-[1.8] w-[80%] mt-10 font-light">We’re a team of designers, developers, and strategists who are passionate about creating digital experiences that are both beautiful and functional.
       </p>
